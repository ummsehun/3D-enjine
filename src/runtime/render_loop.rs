...
use crate::{
    ...
    scene::{
        ...
        AudioReactiveMode, BrailleProfile, CameraControlMode, CameraMode, CellAspectMode,
        CinematicCameraMode, ColorMode, KittyInternalResPreset, MeshLayer, RenderConfig,
        RenderMode, RenderOutputMode, SceneCpu, StageRole,
    },
    terminal::{PresentMode, TerminalProfile, TerminalSession},
};

fn set_runtime_panic_state(line: String) {
    crate::runtime::app::set_runtime_panic_state(line);
}
